...
include('../includes/data.php');
      ...
      //  echo $id_delete;
       if(isset($_GET['agree'])){
         ...
         $delete_product=mysqli_query($connect,"UPDATE `products` SET `quantityInStock` = -1 WHERE `products`.`id` = $id_delete");
         $delete_productdetails=mysqli_query($connect,"UPDATE `productdetails` SET `isdeleted` = 1 WHERE `id` = $id_delete");
         if($delete_product){
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <form action="delete.php?<?php echo $_GET['delete']?>" method="GET" enctype="multipart/form-data">
